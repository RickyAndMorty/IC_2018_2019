...
arquivo = fopen('C:/git/IC_2018_2019/OTIMIZACAO_OCDMA_1/resultados/SNIRdB.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
...
arquivo = fopen('C:/git/IC_2018_2019/OTIMIZACAO_OCDMA_1/resultados/SNIR.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
...
arquivo = fopen('C:/git/IC_2018_2019/OTIMIZACAO_OCDMA_1/resultados/Pgbest.bin');
% A = fscanf(arquivo,'%f',[colunas linhas]);
...
figure(4)
arquivo = fopen('C:/git/IC_2018_2019/OTIMIZACAO_OCDMA_1/resultados/power.bin');
